// ============================================================
// 상동역 롯데캐슬 시그니처 — verified content / facts
...
// 공식 사업개요 — 아파트 주택타입 및 세대수 (출처: 상동역 롯데캐슬 시그니처 관심고객등록 이벤트 페이지)
